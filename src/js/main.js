...
import night from "../asset/night-mode.png";
import day from "../asset/day-mode.png";
...
export default function run() {
	...
	Element.dark.addEventListener("click", function () {
		mode = this.checked;
		if (mode == true) {
			Element.sliderIcon.setAttribute("src", night);
			darkMode(mode);
		} else {
			Element.sliderIcon.setAttribute("src", day);
			darkMode(mode);
		}
	});
